...
def test_backward_bounds_regression(shape, backward_bound, batchsize, loss_fn, seed):
    """
...
def test_backward_bounds_binary_classification(shape, backward_bound, batchsize, loss_fn, seed):
    """
...
def test_backward_bounds_classification(shape, backward_bound, batchsize, loss_fn, seed):
    """
